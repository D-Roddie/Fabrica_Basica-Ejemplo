...
public class JavamonOSController {
    ...
    public void sendJavamonToNintengoClassic(Javamon pJavamon){
        ...
        comManager.SendJavamon(pJavamon, Platform.NINTENGO_CLASSIC);
    }
	...
	public void sendJavamonToNintengoGameBoy(Javamon pJavamon) {
        CommunicationManager comManager = new CommunicationManager();
        comManager.SendJavamon(pJavamon, Platform.NINTENGO_GAMEBOY);
